      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto text-center space-y-8">
          ...
          <p className="text-xl md:text-2xl text-primary-foreground/90 max-w-3xl mx-auto leading-relaxed animate-fade-in text-balance">
            We help businesses generate high-quality leads and accelerate growth through Google Ads, Meta Ads, Upwork Lead Generation, and LinkedIn Outreach. Our data-driven marketing strategies, compelling proposals, and targeted campaigns connect you with the right clients while maximizing your return on investment.
          </p>
